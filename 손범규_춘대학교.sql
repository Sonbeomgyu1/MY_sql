...
CREATE TABLE "TB_STUDENT" (
	...
	"ENTRACE_DATE"	DATE	NULL,
	"ABSENCS_YN"	CHAR(1)	NULL,
	"DEPARTMENT_NO2"	VARCHAR2(10)	NULL,	
...
CREATE TABLE "TB_PROFESSOR" (
	"PROFESSOR_NO"	VARCHAR2(10)	NOT NULL,
	"PROFEESOR_NAME"	VARCHAR2(30)	NULL,
...
CREATE TABLE "TB_GRADE" (
	"TEPM_NO"	VARCHAR2(10)	NOT NULL,
	"STUDENT_NO2"	VARCHAR2(10)	NOT NULL,
	"CALSS_NO"	VARCHAR2(10)	NULL,
	"POINT"	NUMBER(3,2)	NULL
);
COMMENT ON COLUMN "TB_GRADE"."STUDENT_NO" IS '학번 YYYYN_구성';
